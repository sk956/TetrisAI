...
public class Tetris extends JPanel implements Runnable {
	...
	static ArrayList<Shape> autoshapes = new ArrayList<Shape>();
	boolean manualYN = true;
	...
	public void automaticPlay(int rotate, int left, int right) {
		if (scoreboard.isGameOver()) {
			return;
		}
	...
	void selectShape() {
		...
		if (!manualYN && fallingShape != null) {
			...
			System.out.println("rotate: " + fallingShape.rotate + "l: " + fallingShape.left + "r: " + fallingShape.right);
			
			automaticPlay(fallingShape.rotate, fallingShape.left, fallingShape.right);
		}
	...
	@Override
	public void run() {
		autoshapes.add(Shape.Square);
		autoshapes.add(Shape.IShape);
		autoshapes.add(Shape.JShape) ; 
		autoshapes.add(Shape.TShape); 
		autoshapes.add(Shape.ZShape); 
		autoshapes.add(Shape.ZShape); 
		autoshapes.add(Shape.LShape);
		autoshapes.add(Shape.SShape);
		autoshapes.add(Shape.JShape);
		autoshapes.add(Shape.Square);
		autoshapes.add(Shape.IShape);
		autoshapes.add(Shape.JShape) ; 
